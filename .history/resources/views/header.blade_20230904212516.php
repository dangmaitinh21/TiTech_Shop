				...
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						<ul class="flex-c-m">
							...
							@endphp
							<li>
								<a href="#" class="p-lr-25 p-tb-10">
									Hello {{ $username }}
								</a>
							</li>

							<li>
								<a href="#" class="trans-04 p-lr-25 p-tb-10">
									Logout
								</a>
							</li>
							...
							<li>
								<a href="/login" class="trans-04 p-lr-25 p-tb-10">
									Login
								</a>
							</li>
	
							<li>
								<a href="/register" class="trans-04 p-lr-25 p-tb-10">
									Register
								</a>
							</li>
							@endif
