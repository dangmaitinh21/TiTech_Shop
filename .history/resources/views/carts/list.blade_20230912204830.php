            ...
            <div class="row">
                <div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
                    ...
                    <div class="m-l-25 m-r--38 m-lr-0-xl">
                        ...
                        <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                            ...
                            <input class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10" type="submit" value="Update cart" formaction="/carts/update-cart" />
                ...
                <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
                    <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                        ...
                        <div class="bor12 p-t-15 p-b-30">
							<div class="w-full">
								<div class="p-t-15">
                                    ...
                                    <div class="bor8 bg0 m-b-22">
										<textarea class="stext-111 cl8 plh3 size-111 p-lr-15" name="note" placeholder="Note..."></textarea>
									</div>

                                    <label for="card-element">
                                        Credit or debit card
                                    </label>
                                    <div class="bor8 bg0 m-b-22 p-tb-10 p-lr-10">
                                        <div id="card-element">
									</div>
								</div>
							</div>
                        ...
                        <button class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer" type="submit" formaction="/carts/add-cart">
                            Buy
                        </button>
                    </div>
                </div>
