    ...
    <form action="" method="POST">
        <div class="card-body">
            <div class="form-group">
                <label for="name">Name slider</label>
                <input type="text" class="form-control" name="name" id="name" placeholder="Enter name product" value="{{ $product->name }}">
            </div>
            <div class="form-group">
                <label for="fileImg">Slider image</label><br>
                <div class="input-group">
                    <input type="file" id="fileImg">
                    <input type="hidden" name="image" value="{{ $product->image }}" id="dataUrlImage">
                </div>
