    ...
    <form action="" method="POST">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="categoryOfProduct" value="{{ old('categoryOfProduct') }}"  >
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control" name="productDescription"  id="description" placeholder="Enter description" value="{{ old('productDescription') }}"></textarea>
            </div>
            <div class="form-group">
                <label for="content">Content</label>
                <textarea type="text" class="form-control" name="productDetail"  id="content" placeholder="Enter content" value="{{ old('productDetail') }}"></textarea>
            </div>
            <div class="form-group">
