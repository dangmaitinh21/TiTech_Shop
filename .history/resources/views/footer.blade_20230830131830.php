			...
			<div class="row">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="/template/images/product-detail-01.jpg" id="dataProduct-1">
									<div class="wrap-pic-w pos-relative">
										<img src="/template/images/product-detail-01.jpg" alt="IMG-PRODUCT" id="dataProduct-2">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						<h4 class="mtext-105 cl2 js-name-detail p-b-14" id="dataProduct-3">
							
						</h4>

						<span class="mtext-106 cl2" id="dataProduct-4">
							
						</span>

						<p class="stext-102 cl3 p-t-23" id="dataProduct-5">
