...
Route::middleware(['web', 'auth'])->group(function() {
    Route::prefix('admin')->group(function() {
        ...
        Route::prefix('products')->group(function() {
            Route::get('add', [ProductsController::class, 'index']);
            Route::post('add', [ProductsController::class, 'create']);
            // Route::get('list', [ProductsController::class, 'getCategories']);
            // Route::get('edit/{category}', [ProductsController::class, 'editFormCategory']);
            // Route::post('edit/{category}', [ProductsController::class, 'updateCategory']);
            // Route::delete('delete', [ProductsController::class, 'delCategory']);
        });
    });
});
