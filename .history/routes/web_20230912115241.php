...
Route::prefix('carts')->group(function() {
    ...
    // Route::get('payment', 'StripePaymentsController@payment');
});

// Route::get('checkout', [StripePaymentController::class, 'test']);
Route::get('checkout', 'App\Http\Controllers\StripePaymentController@test');